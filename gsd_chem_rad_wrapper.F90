...
!! Haiqin.Li@noaa.gov 06/2020
 ...
 module gsd_chem_rad_wrapper
   ...
   public :: gsd_chem_rad_wrapper_init, gsd_chem_rad_wrapper_run, gsd_chem_rad_wrapper_finalize

contains

!> \brief Brief description of the subroutine
!!
      subroutine gsd_chem_rad_wrapper_init()
      end subroutine gsd_chem_rad_wrapper_init

!> \brief Brief description of the subroutine
!!
!! \section arg_table_gsd_chem_rad_wrapper_finalize Argument Table
!!
      subroutine gsd_chem_rad_wrapper_finalize()
      end subroutine gsd_chem_rad_wrapper_finalize

!> \defgroup gsd_chem_group GSD Chem driver Module
!! This is the gsd chemistry
!>\defgroup gsd_chem_rad_wrapper GSD Chem driver Module  
!> \ingroup gsd_chem_group
!! This is the GSD Chem driver Module
!! \section arg_table_gsd_chem_rad_wrapper_run Argument Table
!! \htmlinclude gsd_chem_rad_wrapper_run.html
!!
!>\section gsd_chem_rad_wrapper GSD Chemistry Scheme General Algorithm
!> @{
...
!> @}
  ...
  end subroutine gsd_chem_prep_rad
!> @}
  end module gsd_chem_rad_wrapper

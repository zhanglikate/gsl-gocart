...
!! Haiqin.Li@noaa.gov 06/2020
 ...
 module gsd_chem_settling_wrapper
   ...
   public :: gsd_chem_settling_wrapper_init, gsd_chem_settling_wrapper_run, gsd_chem_settling_wrapper_finalize

contains

!> \brief Brief description of the subroutine
!!
    subroutine gsd_chem_settling_wrapper_init()
    end subroutine gsd_chem_settling_wrapper_init

!> \brief Brief description of the subroutine
!!
!! \section arg_table_gsd_chem_settling_wrapper_finalize Argument Table
!!
    subroutine gsd_chem_settling_wrapper_finalize()
    end subroutine gsd_chem_settling_wrapper_finalize

!> \defgroup gsd_chem_group GSD Chem driver Module
!! This is the gsd chemistry
!>\defgroup gsd_chem_settling_wrapper GSD Chem driver Module  
!> \ingroup gsd_chem_group
!! This is the GSD Chem driver Module
!! \section arg_table_gsd_chem_settling_wrapper_run Argument Table
!! \htmlinclude gsd_chem_settling_wrapper_run.html
!!
...
!>- get ready for chemistry run
    call gsd_chem_prep_settling(ktau,garea,                             &
...
!> @}
   subroutine gsd_chem_prep_settling(ktau,garea,                       &
        pr3d,ph3d,tk3d,prl3d,spechum,dxy,                              &
        t_phy,p_phy,rho_phy,dz8w,p8w,                                  &
        ntso2,ntsulf,ntDMS,ntmsa,ntpp25,                               &
        ntbc1,ntbc2,ntoc1,ntoc2,                                       &
  ...
  end subroutine gsd_chem_prep_settling
!> @}
  end module gsd_chem_settling_wrapper

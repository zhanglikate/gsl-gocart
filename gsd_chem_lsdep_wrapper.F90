...
!! Haiqin.Li@noaa.gov 06/2020
 ...
 module gsd_chem_lsdep_wrapper
   ...
   public :: gsd_chem_lsdep_wrapper_init, gsd_chem_lsdep_wrapper_run, gsd_chem_lsdep_wrapper_finalize
...
!> \brief Brief description of the subroutine
!!
!! \section arg_table_gsd_chem_lsdep_wrapper_finalize Argument Table
!!
      subroutine gsd_chem_lsdep_wrapper_finalize()
      end subroutine gsd_chem_lsdep_wrapper_finalize

!> \defgroup gsd_chem_group GSD Chem driver Module
!! This is the gsd chemistry
!>\defgroup gsd_chem_lsdep_wrapper GSD Chem driver Module  
!> \ingroup gsd_chem_group
!! This is the GSD Chem driver Module
!! \section arg_table_gsd_chem_lsdep_wrapper_run Argument Table
!! \htmlinclude gsd_chem_lsdep_wrapper_run.html
!!
...
!> @}
  end module gsd_chem_lsdep_wrapper
